...
var setting = {
	...
	$.get(ctx + "system/menu/roleMenuTreeData?roleId=" + $("#roleId").val(), function(response) {
	...
	rules:{
		roleName:{
			...
			remote: {
               ...
               //  	alert(element.value != $('#oldRoleName').val());
               //     if(element.value == $('#oldRoleName').val()) return;
               //    //  return (element.value !== $('#oldRoleName').val());
               //  },
