package com.JWmes.project.tool.gen.util;

import java.util.ArrayList;
import java.util.List;

import com.JWmes.common.constant.CommonConstant;
import com.JWmes.common.constant.CommonMap;
...
{
    /** 项目空间路径 */
    private static final String projectPath = "main/java/com/JWmes/business";
    ...
    /** js空间路径 */
    private static final String javascriptPath = "main/resources/static/JW/";

    /**
     * 设置列信息
     */
    public static List<ColumnInfoEntity> transColums(List<ColumnInfoEntity> columns)
    {
        // 列信息
        List<ColumnInfoEntity> columsList = new ArrayList<>();
        for (ColumnInfoEntity column : columns)
        {
            // 列名转换成Java属性名
     ...
     * @return 模板列表
     */
    public static VelocityContext getVelocityContext(TableInfoEntity table)
    {
        // java对象数据传递到模板文件vm
     ...
     * 获取文件名
     */
    public static String getFileName(String template, TableInfoEntity table, String moduleName)
    {
        // 小写类名
        ...
        {
            return classname + "MenuEntity.sql";
        }
        return null;
    }
    ...
    public static void main(String[] args)
    {
        ...
        System.out.println(getModuleName("com.JWmes.business.system"));
    }
}
