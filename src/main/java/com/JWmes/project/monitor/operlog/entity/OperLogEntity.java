package com.JWmes.project.monitor.operlog.entity;
 ...
 * @author zhong
 */
public class OperLogEntity extends PageDomain
{
    /** 日志主键 */
    ...
    {
        return "OperLogEntity [operId=" + operId + ", title=" + title + ", action=" + action + ", method=" + method
