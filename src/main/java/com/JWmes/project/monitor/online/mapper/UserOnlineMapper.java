package com.JWmes.project.monitor.online.mapper;
...
public interface UserOnlineMapper
{
     ...
     * @return 结果
     */
    public int saveOnline(UserOnlineEntity online);
     ...
     * @return 会话集合
     */
    public List<UserOnlineEntity> selectOnlineByExpired(String lastAccessTime);
}
