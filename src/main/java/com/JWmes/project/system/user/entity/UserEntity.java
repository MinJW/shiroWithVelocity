 ...
 * @author zhong
 */
public class UserEntity extends PageDomain
{
    /** 用户ID */
    private Long userId;
    /** 部门ID */
    ...
    {
        return "UserEntity [userId=" + userId + ", deptId=" + deptId + ", parentId=" + parentId + ", loginName=" + loginName
                + ", userName=" + userName + ", email=" + email + ", phonenumber=" + phonenumber + ", password="
                + password + ", salt=" + salt + ", userType=" + userType + ", status=" + status + ", delFlag=" + delFlag + ", refuseDes="
