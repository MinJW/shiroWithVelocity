package com.JWmes.framework.shiro.web.filter.online;
...
public class OnlineSessionFilter extends AccessControlFilter
{
            ...
            throws Exception
    {
        ...
        Session session = onlineSessionMapper.readSession(subject.getSession().getId());
        if (session != null && session instanceof OnlineSessionEntity)
        {
            ...
            if (onlineSession.getStatus() == OnlineSessionEntity.OnlineStatus.off_line)
            {
                return false;
            }
        }
